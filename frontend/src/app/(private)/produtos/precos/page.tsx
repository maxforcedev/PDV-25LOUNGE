...
function BranchPrices() {
  ...
  return <>
    <PageHeader title="Preços por filial" description="Compare e ajuste preços de produtos por filial." action={<Link href="/produtos" className="btn btn-secondary"><ArrowLeft className="size-4" />Voltar aos produtos</Link>} />

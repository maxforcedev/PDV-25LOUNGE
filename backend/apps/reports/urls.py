...
urlpatterns = [
    ...
    path('reports/tickets/', TicketsReportView.as_view(), name='report-tickets'),
    path('reports/tickets/<int:pk>/', TicketReportDetailView.as_view(), name='report-ticket-detail'),
    path('reports/ticket-options/', TicketsReportOptionsView.as_view(), name='report-ticket-options'),

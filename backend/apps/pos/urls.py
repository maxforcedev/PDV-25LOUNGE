...
from .views import (
    ...
    POSCashSessionEntryView, POSCashSessionOpenView, POSCashSessionSelectView, POSCashSessionSummaryView,
...
urlpatterns = [
    ...
    path('cash/sessions/select/', POSCashSessionSelectView.as_view(), name='cash-session-select'),

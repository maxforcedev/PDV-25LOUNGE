...
def modules_for(operator, device, *, permission_codes=None):
    ...
    return permissions, {
        ...
        'tables': {'enabled': bool(operational and settings_obj and settings_obj.uses_tables and settings_obj.uses_commands and permissions.intersection({'tables.view', 'tables.open'}))},

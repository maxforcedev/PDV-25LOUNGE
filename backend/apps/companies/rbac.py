...
OPERATING_PERMISSION_CODES = frozenset(
    ...
    if (
        code.split('.', 1)[0]
        in {'products', 'categories', 'inventory', 'purchases', 'cash_registers', 'sales', 'payment_methods', 'promotions', 'reports', 'dashboard', 'branch_prices', 'audit_logs', 'commands', 'modifiers'}
        or code in {
            'commissions.view',

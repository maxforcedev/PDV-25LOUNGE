PERMISSION_CATALOG = (
    ...
    ('tables.open', 'tables', 'Abrir mesas', 'Abrir mesas e criar sua comanda principal.'),
...
BRANCH_PERMISSION_CODES = frozenset({
    ...
    'tables.view', 'tables.manage', 'tables.open', 'tables.transfer', 'tables.transfer_items', 'tables.merge',
    'tables.close',

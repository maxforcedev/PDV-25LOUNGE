ACTION_LABELS = {
    ...
    'modifier_group.delete': 'Grupo de modificador excluído',
    'modifier_option.delete': 'Opção de modificador excluída',
    ...
    'product_modifier_link.delete': 'Modificador desvinculado do produto',

...
> **Versão:** 1.4
> **Data:** 2026-08-16  
> **Status:** PRD técnico — MVP revisado após validação de Caixa/PDV, com correções de contrato monetário, consumação integrada ao checkout, RBAC administrativo resiliente, filtros temporais com data/hora, dashboard operacional, relatórios e promoções simples  

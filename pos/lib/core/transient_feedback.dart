              ...
              child: ConstrainedBox(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: alert == null
                      ...
                      : _TransientAlertCard(
                          key: ValueKey(alert!.id), alert: alert!),
                ),
              ),
            ),
          ),
    ...
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x1a283c50), blurRadius: 20, offset: Offset(0, 8)),
          ],
        ),
        child: Row(
          ...
          children: [
            ...
            Expanded(
                child: Text(alert.message,
                    style: TextStyle(color: style.color, height: 1.35))),
          ],
        ),
      ),
    );
